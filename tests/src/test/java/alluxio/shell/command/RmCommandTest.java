...
public final class RmCommandTest extends AbstractAlluxioShellTest {
  @Test
  public void rmNotExistingDir() throws IOException, AlluxioException {
  ...
  @Test
  public void rmNotExistingFile() throws IOException, AlluxioException {
  ...
  @Test
  public void rm() throws IOException, AlluxioException {
    StringBuilder toCompare = new StringBuilder();
