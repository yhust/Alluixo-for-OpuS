...
struct GetOpuSInfoTOptions {}
struct GetOpuSInfoTResponse {
  1: string opuSInfo
}
...
service FileSystemMasterClientService extends common.AlluxioService {
  ...
  /**
    * Returns the info of the OpuS allocation
    */
  GetOpuSInfoTResponse getOpuSInfo(
    /** the path of the file or directory */ 1: string path,
    /** user id */ 2: i32 userId,
    3: GetOpuSInfoTOptions options,
    )
    throws (1: exception.AlluxioTException e)
