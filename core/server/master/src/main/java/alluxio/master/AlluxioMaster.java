...
public final class AlluxioMaster {
  ...
  public static void main(String[] args) {
    ...
    Timer time = new Timer(); // Run Opus
    OpuSMaster opusMaster = new OpuSMaster();
    LOG.info("start Opus");
    // time.schedule(opusMaster, 0, 20000); // Create Repetitively task for every 20 secs
