...
public final class RetryHandlingFileSystemMasterClient extends AbstractMasterClient
  ...
  @Override
  public synchronized String getOpuSInfo(final AlluxioURI path, final int userId, final GetOpuSInfoTOptions options)
          throws IOException {
    return retryRPC(new RpcCallable<String>() {
      @Override
      public String call() throws TException {
        return mClient.getOpuSInfo(path.getPath(), userId, new GetOpuSInfoTOptions())
                .getOpuSInfo();
      }
    });
  }
